...
<style>
       body {
        background-image: url('background/cream.jpg');
        }
    </style>
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/logo3.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="logos/logo4.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
