...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SPARKS BANK <img src="logos/logo1.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <strong>Good Banking is produced not by good laws, but by good bankers.</strong> </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/back2.jpg" width="500" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/back.jpg" width="1000" height="375" class="d-block w-100" alt="...">
