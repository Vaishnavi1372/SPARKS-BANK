...
<class class="welcome">
        <h2>
            <img src="logos/logo5.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logos/logo6.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
